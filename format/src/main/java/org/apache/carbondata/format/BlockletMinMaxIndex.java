...
public class BlockletMinMaxIndex implements org.apache.thrift.TBase<BlockletMinMaxIndex, BlockletMinMaxIndex._Fields>, java.io.Serializable, Cloneable, Comparable<BlockletMinMaxIndex> {
  ...
  private static final org.apache.thrift.protocol.TField MIN_MAX_PRESENCE_FIELD_DESC = new org.apache.thrift.protocol.TField("min_max_presence", org.apache.thrift.protocol.TType.LIST, (short)3);
  ...
  private static final _Fields optionals[] = {_Fields.MIN_MAX_PRESENCE};
  ...
  static {
    ...
    tmpMap.put(_Fields.MAX_VALUES, new org.apache.thrift.meta_data.FieldMetaData("max_values", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING            , true))));
    tmpMap.put(_Fields.MIN_MAX_PRESENCE, new org.apache.thrift.meta_data.FieldMetaData("min_max_presence", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
  ...
  public int getMin_max_presenceSize() {
    return (this.min_max_presence == null) ? 0 : this.min_max_presence.size();
  }

  public java.util.Iterator<Boolean> getMin_max_presenceIterator() {
    return (this.min_max_presence == null) ? null : this.min_max_presence.iterator();
  }

  public void addToMin_max_presence(boolean elem) {
    if (this.min_max_presence == null) {
      this.min_max_presence = new ArrayList<Boolean>();
    }
    this.min_max_presence.add(elem);
  }
  ...
  public BlockletMinMaxIndex setMin_max_presence(List<Boolean> min_max_presence) {
    this.min_max_presence = min_max_presence;
    return this;
  }
  ...
  public void setMin_max_presenceIsSet(boolean value) {
    if (!value) {
      this.min_max_presence = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MIN_MAX_PRESENCE:
      if (value == null) {
        ...
        setMin_max_presence((List<Boolean>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.min_max_presence = new ArrayList<Boolean>(_list14.size);
                boolean _elem15;
                for (int _i16 = 0; _i16 < _list14.size; ++_i16)
                {
                  _elem15 = iprot.readBool();
                  struct.min_max_presence.add(_elem15);
                }
                iprot.readListEnd();
              }
              struct.setMin_max_presenceIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BlockletMinMaxIndex struct) throws org.apache.thrift.TException {
      ...
      if (struct.min_values != null) {
        oprot.writeFieldBegin(MIN_VALUES_FIELD_DESC);
        {
          ...
          for (ByteBuffer _iter17 : struct.min_values)
          {
      ...
      if (struct.max_values != null) {
        oprot.writeFieldBegin(MAX_VALUES_FIELD_DESC);
        {
          ...
          for (ByteBuffer _iter18 : struct.max_values)
          {
      ...
      if (struct.min_max_presence != null) {
        if (struct.isSetMin_max_presence()) {
          oprot.writeFieldBegin(MIN_MAX_PRESENCE_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.BOOL, struct.min_max_presence.size()));
            for (boolean _iter19 : struct.min_max_presence)
            {
  ...
  private static class BlockletMinMaxIndexTupleScheme extends TupleScheme<BlockletMinMaxIndex> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, BlockletMinMaxIndex struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (ByteBuffer _iter20 : struct.min_values)
        {
      ...
      }
      {
        ...
        for (ByteBuffer _iter21 : struct.max_values)
        {
      ...
      if (struct.isSetMin_max_presence()) {
        {
          oprot.writeI32(struct.min_max_presence.size());
          for (boolean _iter22 : struct.min_max_presence)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BlockletMinMaxIndex struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.min_values = new ArrayList<ByteBuffer>(_list23.size);
        ByteBuffer _elem24;
        for (int _i25 = 0; _i25 < _list23.size; ++_i25)
        {
          _elem24 = iprot.readBinary();
          struct.min_values.add(_elem24);
        }
      }
      struct.setMin_valuesIsSet(true);
      {
        ...
        struct.max_values = new ArrayList<ByteBuffer>(_list26.size);
        ByteBuffer _elem27;
        for (int _i28 = 0; _i28 < _list26.size; ++_i28)
        {
          _elem27 = iprot.readBinary();
          struct.max_values.add(_elem27);
        }
      }
      struct.setMax_valuesIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.min_max_presence = new ArrayList<Boolean>(_list29.size);
          boolean _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = iprot.readBool();
            struct.min_max_presence.add(_elem30);
          }
        }
        struct.setMin_max_presenceIsSet(true);
      }
