...
public class FileFooter implements org.apache.thrift.TBase<FileFooter, FileFooter._Fields>, java.io.Serializable, Cloneable, Comparable<FileFooter> {
  ...
  private static final org.apache.thrift.protocol.TField BLOCKLET_INFO_LIST2_FIELD_DESC = new org.apache.thrift.protocol.TField("blocklet_info_list2", org.apache.thrift.protocol.TType.LIST, (short)7);
  private static final org.apache.thrift.protocol.TField DICTIONARY_FIELD_DESC = new org.apache.thrift.protocol.TField("dictionary", org.apache.thrift.protocol.TType.STRUCT, (short)8);
  ...
  public List<BlockletInfo> blocklet_info_list; // optional
  public List<BlockletInfo2> blocklet_info_list2; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BLOCKLET_INFO_LIST2((short)7, "blocklet_info_list2"),
    DICTIONARY((short)8, "dictionary");
  ...
  private static final _Fields optionals[] = {_Fields.BLOCKLET_INFO_LIST,_Fields.BLOCKLET_INFO_LIST2,_Fields.DICTIONARY};
  ...
  static {
    ...
    tmpMap.put(_Fields.BLOCKLET_INFO_LIST, new org.apache.thrift.meta_data.FieldMetaData("blocklet_info_list", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, BlockletInfo.class))));
    tmpMap.put(_Fields.BLOCKLET_INFO_LIST2, new org.apache.thrift.meta_data.FieldMetaData("blocklet_info_list2", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, BlockletInfo2.class))));
  ...
  public FileFooter(FileFooter other) {
    ...
    if (other.isSetBlocklet_info_list2()) {
      List<BlockletInfo2> __this__blocklet_info_list2 = new ArrayList<BlockletInfo2>(other.blocklet_info_list2.size());
      for (BlockletInfo2 other_element : other.blocklet_info_list2) {
        __this__blocklet_info_list2.add(new BlockletInfo2(other_element));
      }
  ...
  public java.util.Iterator<BlockletInfo2> getBlocklet_info_list2Iterator() {
  ...
  /** Returns true if field blocklet_info_list2 is set (has been assigned a value) and false otherwise */
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BLOCKLET_INFO_LIST2:
      if (value == null) {
        ...
        setBlocklet_info_list2((List<BlockletInfo2>)value);
      }
      break;
  ...
  public boolean equals(FileFooter that) {
    ...
    boolean this_present_blocklet_info_list2 = true && this.isSetBlocklet_info_list2();
    boolean that_present_blocklet_info_list2 = true && that.isSetBlocklet_info_list2();
  ...
  public int hashCode() {
    ...
    boolean present_blocklet_info_list2 = true && (isSetBlocklet_info_list2());
    list.add(present_blocklet_info_list2);
    if (present_blocklet_info_list2)
      list.add(blocklet_info_list2);
  ...
  public int compareTo(FileFooter other) {
    ...
    lastComparison = Boolean.valueOf(isSetBlocklet_info_list2()).compareTo(other.isSetBlocklet_info_list2());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBlocklet_info_list2()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.blocklet_info_list2, other.blocklet_info_list2);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_columns = new ArrayList<org.apache.carbondata.format.ColumnSchema>(_list144.size);
                org.apache.carbondata.format.ColumnSchema _elem145;
                for (int _i146 = 0; _i146 < _list144.size; ++_i146)
                {
                  _elem145 = new org.apache.carbondata.format.ColumnSchema();
                  _elem145.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                BlockletIndex _elem148;
                for (int _i149 = 0; _i149 < _list147.size; ++_i149)
                {
                  _elem148 = new BlockletIndex();
                  _elem148.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                BlockletInfo _elem151;
                for (int _i152 = 0; _i152 < _list150.size; ++_i152)
                {
                  _elem151 = new BlockletInfo();
                  _elem151.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                BlockletInfo2 _elem154;
                for (int _i155 = 0; _i155 < _list153.size; ++_i155)
                {
                  _elem154 = new BlockletInfo2();
                  _elem154.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileFooter struct) throws org.apache.thrift.TException {
      ...
      if (struct.table_columns != null) {
        oprot.writeFieldBegin(TABLE_COLUMNS_FIELD_DESC);
        {
          ...
          for (org.apache.carbondata.format.ColumnSchema _iter156 : struct.table_columns)
          {
      ...
      if (struct.blocklet_info_list2 != null) {
        if (struct.isSetBlocklet_info_list2()) {
          oprot.writeFieldBegin(BLOCKLET_INFO_LIST2_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.blocklet_info_list2.size()));
  ...
  private static class FileFooterTupleScheme extends TupleScheme<FileFooter> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, FileFooter struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.num_rows);
      {
        ...
        for (org.apache.carbondata.format.ColumnSchema _iter160 : struct.table_columns)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, FileFooter struct) throws org.apache.thrift.TException {
      ...
      struct.setNum_rowsIsSet(true);
      {
        ...
        struct.table_columns = new ArrayList<org.apache.carbondata.format.ColumnSchema>(_list164.size);
        org.apache.carbondata.format.ColumnSchema _elem165;
        for (int _i166 = 0; _i166 < _list164.size; ++_i166)
        {
          _elem165 = new org.apache.carbondata.format.ColumnSchema();
          _elem165.read(iprot);
      ...
      struct.setSegment_infoIsSet(true);
      {
        ...
        BlockletIndex _elem168;
        for (int _i169 = 0; _i169 < _list167.size; ++_i169)
        {
          _elem168 = new BlockletIndex();
          _elem168.read(iprot);
      ...
      if (incoming.get(0)) {
        {
          ...
          BlockletInfo _elem171;
          for (int _i172 = 0; _i172 < _list170.size; ++_i172)
          {
            _elem171 = new BlockletInfo();
            _elem171.read(iprot);
      ...
      if (incoming.get(1)) {
        {
          ...
          BlockletInfo2 _elem174;
          for (int _i175 = 0; _i175 < _list173.size; ++_i175)
          {
            _elem174 = new BlockletInfo2();
            _elem174.read(iprot);
