...
public class ChunkCompressionMeta implements org.apache.thrift.TBase<ChunkCompressionMeta, ChunkCompressionMeta._Fields>, java.io.Serializable, Cloneable, Comparable<ChunkCompressionMeta> {
  ...
  private static final org.apache.thrift.protocol.TField COMPRESSOR_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("compressor_name", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * compressor name for chunk, this is introduced in 1.5.0 to make compression for final store more extensible. We will first check compression_codec, if it is not set, we will use this compressor_name *
     */
    COMPRESSOR_NAME((short)4, "compressor_name");
  ...
  private static final _Fields optionals[] = {_Fields.COMPRESSOR_NAME};
   ...
   * compressor name for chunk, this is introduced in 1.5.0 to make compression for final store more extensible. We will first check compression_codec, if it is not set, we will use this compressor_name *
   */
  public ChunkCompressionMeta setCompressor_name(String compressor_name) {
