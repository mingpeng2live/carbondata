            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.column_ids = new ArrayList<Integer>(_list32.size);
                int _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = iprot.readI32();
                  struct.column_ids.add(_elem33);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.encoders = new ArrayList<org.apache.carbondata.format.Encoding>(_list35.size);
                org.apache.carbondata.format.Encoding _elem36;
                for (int _i37 = 0; _i37 < _list35.size; ++_i37)
                {
                  _elem36 = org.apache.carbondata.format.Encoding.findByValue(iprot.readI32());
                  struct.encoders.add(_elem36);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.encoder_meta = new ArrayList<ByteBuffer>(_list38.size);
                ByteBuffer _elem39;
                for (int _i40 = 0; _i40 < _list38.size; ++_i40)
                {
                  _elem39 = iprot.readBinary();
                  struct.encoder_meta.add(_elem39);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataChunk struct) throws org.apache.thrift.TException {
      ...
      if (struct.column_ids != null) {
        oprot.writeFieldBegin(COLUMN_IDS_FIELD_DESC);
        {
          ...
          for (int _iter41 : struct.column_ids)
          {
      ...
      if (struct.encoders != null) {
        if (struct.isSetEncoders()) {
          oprot.writeFieldBegin(ENCODERS_FIELD_DESC);
          {
            ...
            for (org.apache.carbondata.format.Encoding _iter42 : struct.encoders)
            {
      ...
      if (struct.encoder_meta != null) {
        if (struct.isSetEncoder_meta()) {
          oprot.writeFieldBegin(ENCODER_META_FIELD_DESC);
          {
            ...
            for (ByteBuffer _iter43 : struct.encoder_meta)
            {
  ...
  private static class DataChunkTupleScheme extends TupleScheme<DataChunk> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, DataChunk struct) throws org.apache.thrift.TException {
      ...
      oprot.writeBool(struct.rowMajor);
      {
        ...
        for (int _iter44 : struct.column_ids)
        {
      ...
      if (struct.isSetEncoders()) {
        {
          ...
          for (org.apache.carbondata.format.Encoding _iter45 : struct.encoders)
          {
      ...
      if (struct.isSetEncoder_meta()) {
        {
          ...
          for (ByteBuffer _iter46 : struct.encoder_meta)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, DataChunk struct) throws org.apache.thrift.TException {
      ...
      struct.setRowMajorIsSet(true);
      {
        ...
        struct.column_ids = new ArrayList<Integer>(_list47.size);
        int _elem48;
        for (int _i49 = 0; _i49 < _list47.size; ++_i49)
        {
          _elem48 = iprot.readI32();
          struct.column_ids.add(_elem48);
        }
      }
      struct.setColumn_idsIsSet(true);
      struct.data_page_offset = iprot.readI64();
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.encoders = new ArrayList<org.apache.carbondata.format.Encoding>(_list50.size);
          org.apache.carbondata.format.Encoding _elem51;
          for (int _i52 = 0; _i52 < _list50.size; ++_i52)
          {
            _elem51 = org.apache.carbondata.format.Encoding.findByValue(iprot.readI32());
            struct.encoders.add(_elem51);
          }
        }
        struct.setEncodersIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.encoder_meta = new ArrayList<ByteBuffer>(_list53.size);
          ByteBuffer _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = iprot.readBinary();
            struct.encoder_meta.add(_elem54);
          }
        }
        struct.setEncoder_metaIsSet(true);
      }
