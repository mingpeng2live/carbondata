...
public class BlockIndex implements org.apache.thrift.TBase<BlockIndex, BlockIndex._Fields>, java.io.Serializable, Cloneable, Comparable<BlockIndex> {
  ...
  private static final org.apache.thrift.protocol.TField BLOCKLET_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("blocklet_info", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  ...
  public org.apache.carbondata.format.BlockletInfo3 blocklet_info; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BLOCKLET_INFO((short)5, "blocklet_info"),
  ...
  private static final _Fields optionals[] = {_Fields.BLOCKLET_INFO,_Fields.FILE_SIZE};
  ...
  static {
    ...
    tmpMap.put(_Fields.BLOCKLET_INFO, new org.apache.thrift.meta_data.FieldMetaData("blocklet_info", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.apache.carbondata.format.BlockletInfo3.class)));
  ...
  public org.apache.carbondata.format.BlockletInfo3 getBlocklet_info() {
    return this.blocklet_info;
  }

  public BlockIndex setBlocklet_info(org.apache.carbondata.format.BlockletInfo3 blocklet_info) {
  ...
  public BlockIndex setFile_size(long file_size) {
  ...
  public void unsetFile_size() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __FILE_SIZE_ISSET_ID);
  }

  /** Returns true if field file_size is set (has been assigned a value) and false otherwise */
  public boolean isSetFile_size() {
    return EncodingUtils.testBit(__isset_bitfield, __FILE_SIZE_ISSET_ID);
  }

  public void setFile_sizeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __FILE_SIZE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BLOCKLET_INFO:
      if (value == null) {
        ...
        setBlocklet_info((org.apache.carbondata.format.BlockletInfo3)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_file_size = true && (isSetFile_size());
    list.add(present_file_size);
    if (present_file_size)
      list.add(file_size);
  ...
  public int compareTo(BlockIndex other) {
    ...
    lastComparison = Boolean.valueOf(isSetFile_size()).compareTo(other.isSetFile_size());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFile_size()) {
