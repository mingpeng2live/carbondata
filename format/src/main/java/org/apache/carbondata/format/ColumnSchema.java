...
public class ColumnSchema implements org.apache.thrift.TBase<ColumnSchema, ColumnSchema._Fields>, java.io.Serializable, Cloneable, Comparable<ColumnSchema> {
  ...
  private static final org.apache.thrift.protocol.TField SCHEMA_ORDINAL_FIELD_DESC = new org.apache.thrift.protocol.TField("schemaOrdinal", org.apache.thrift.protocol.TType.I32, (short)16);
  private static final org.apache.thrift.protocol.TField PARENT_COLUMN_TABLE_RELATIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("parentColumnTableRelations", org.apache.thrift.protocol.TType.LIST, (short)17);
   ...
   */
  public int schemaOrdinal; // optional
  /**
   * to maintain the column relation with parent table.
   * will be usefull in case of pre-aggregate
   * 
   */
  public List<ParentColumnTableRelation> parentColumnTableRelations; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * It will have column order which user has provided
     */
    SCHEMA_ORDINAL((short)16, "schemaOrdinal"),
    /**
     * to maintain the column relation with parent table.
     * will be usefull in case of pre-aggregate
     * 
     */
    PARENT_COLUMN_TABLE_RELATIONS((short)17, "parentColumnTableRelations");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 16: // SCHEMA_ORDINAL
          return SCHEMA_ORDINAL;
        case 17: // PARENT_COLUMN_TABLE_RELATIONS
  ...
  private static final _Fields optionals[] = {_Fields.COLUMN_GROUP_ID,_Fields.SCALE,_Fields.PRECISION,_Fields.NUM_CHILD,_Fields.AGGREGATE_FUNCTION,_Fields.DEFAULT_VALUE,_Fields.COLUMN_PROPERTIES,_Fields.INVISIBLE,_Fields.COLUMN_REFERENCE_ID,_Fields.SCHEMA_ORDINAL,_Fields.PARENT_COLUMN_TABLE_RELATIONS};
  ...
  static {
    ...
    tmpMap.put(_Fields.COLUMN_REFERENCE_ID, new org.apache.thrift.meta_data.FieldMetaData("columnReferenceId", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.SCHEMA_ORDINAL, new org.apache.thrift.meta_data.FieldMetaData("schemaOrdinal", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.PARENT_COLUMN_TABLE_RELATIONS, new org.apache.thrift.meta_data.FieldMetaData("parentColumnTableRelations", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "ParentColumnTableRelation"))));
  ...
  public ColumnSchema(ColumnSchema other) {
    ...
    if (other.isSetParentColumnTableRelations()) {
      List<ParentColumnTableRelation> __this__parentColumnTableRelations = new ArrayList<ParentColumnTableRelation>(other.parentColumnTableRelations.size());
      for (ParentColumnTableRelation other_element : other.parentColumnTableRelations) {
        __this__parentColumnTableRelations.add(other_element);
      }
  ...
  public ColumnSchema setSchemaOrdinal(int schemaOrdinal) {
    ...
    setSchemaOrdinalIsSet(true);
    return this;
  }

  public void unsetSchemaOrdinal() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SCHEMAORDINAL_ISSET_ID);
  }

  /** Returns true if field schemaOrdinal is set (has been assigned a value) and false otherwise */
  public boolean isSetSchemaOrdinal() {
    return EncodingUtils.testBit(__isset_bitfield, __SCHEMAORDINAL_ISSET_ID);
  }

  public void setSchemaOrdinalIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SCHEMAORDINAL_ISSET_ID, value);
  }
  ...
  public java.util.Iterator<ParentColumnTableRelation> getParentColumnTableRelationsIterator() {
  ...
  /** Returns true if field parentColumnTableRelations is set (has been assigned a value) and false otherwise */
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SCHEMA_ORDINAL:
      if (value == null) {
        ...
        setSchemaOrdinal((Integer)value);
      }
      break;

    case PARENT_COLUMN_TABLE_RELATIONS:
      if (value == null) {
        unsetParentColumnTableRelations();
      } else {
        setParentColumnTableRelations((List<ParentColumnTableRelation>)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case SCHEMA_ORDINAL:
      return getSchemaOrdinal();

    case PARENT_COLUMN_TABLE_RELATIONS:
      return getParentColumnTableRelations();
  ...
  public boolean isSet(_Fields field) {
    ...
    case SCHEMA_ORDINAL:
      return isSetSchemaOrdinal();
    case PARENT_COLUMN_TABLE_RELATIONS:
      return isSetParentColumnTableRelations();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(ColumnSchema that) {
    ...
    boolean this_present_schemaOrdinal = true && this.isSetSchemaOrdinal();
    boolean that_present_schemaOrdinal = true && that.isSetSchemaOrdinal();
    ...
    boolean this_present_parentColumnTableRelations = true && this.isSetParentColumnTableRelations();
    boolean that_present_parentColumnTableRelations = true && that.isSetParentColumnTableRelations();
  ...
  public int hashCode() {
    ...
    boolean present_schemaOrdinal = true && (isSetSchemaOrdinal());
    list.add(present_schemaOrdinal);
    if (present_schemaOrdinal)
      list.add(schemaOrdinal);

    boolean present_parentColumnTableRelations = true && (isSetParentColumnTableRelations());
    list.add(present_parentColumnTableRelations);
    if (present_parentColumnTableRelations)
      list.add(parentColumnTableRelations);
  ...
  public int compareTo(ColumnSchema other) {
    ...
    lastComparison = Boolean.valueOf(isSetSchemaOrdinal()).compareTo(other.isSetSchemaOrdinal());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSchemaOrdinal()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.schemaOrdinal, other.schemaOrdinal);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetParentColumnTableRelations()).compareTo(other.isSetParentColumnTableRelations());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetParentColumnTableRelations()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.parentColumnTableRelations, other.parentColumnTableRelations);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                ParentColumnTableRelation _elem8;
                for (int _i9 = 0; _i9 < _list7.size; ++_i9)
                {
                  _elem8 = new ParentColumnTableRelation();
                  _elem8.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ColumnSchema struct) throws org.apache.thrift.TException {
      ...
      if (struct.encoders != null) {
        oprot.writeFieldBegin(ENCODERS_FIELD_DESC);
        {
          ...
          for (Encoding _iter10 : struct.encoders)
          {
      ...
      if (struct.columnProperties != null) {
        if (struct.isSetColumnProperties()) {
          oprot.writeFieldBegin(COLUMN_PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter11 : struct.columnProperties.entrySet())
            {
      ...
      if (struct.parentColumnTableRelations != null) {
        if (struct.isSetParentColumnTableRelations()) {
          oprot.writeFieldBegin(PARENT_COLUMN_TABLE_RELATIONS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.parentColumnTableRelations.size()));
            for (ParentColumnTableRelation _iter12 : struct.parentColumnTableRelations)
            {
              _iter12.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class ColumnSchemaTupleScheme extends TupleScheme<ColumnSchema> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ColumnSchema struct) throws org.apache.thrift.TException {
      ...
      struct.setColumnarIsSet(true);
      {
        ...
        {
          _elem17 = org.apache.carbondata.format.Encoding.findByValue(iprot.readI32());
      ...
      if (incoming.get(10)) {
        {
          ...
          ParentColumnTableRelation _elem24;
          for (int _i25 = 0; _i25 < _list23.size; ++_i25)
          {
            _elem24 = new ParentColumnTableRelation();
            _elem24.read(iprot);
